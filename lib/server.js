...
const lookup = require(path.join(__dirname, 'tools/json/lookup'));
...
app.post('/', function(req, res){
  let stationCode = lookup.src(req.body.station); //sttools.match(stationInput);
  let stationLocation = lookup.location(stationCode);
  console.log(stationCode, stationLocation);
